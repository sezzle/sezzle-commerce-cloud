    ...
    $.fn.checkout = function () { // eslint-disable-line
        ...
        function updateUrl(currentStage) {
            ...
            if (checkoutStages[currentStage] == 'payment'){
            	if ($('#sezzle-config').data('sezzleenabled')){            		
                	$('.sezzle-payment-tab').trigger('click');
                }
            }
            else if (checkoutStages[currentStage] == 'placeOrder'){
            	if($('.payment-information').data('payment-method-id') == 'Sezzle'){
            		var url = $('#sezzle-config').data('affirupdateurl');
            		$.spinner().start();
                	$.ajax({
                		url: url,
                		method: 'GET',
        ...
        var members = {
            ...
            updateStage: function () {
                ...
                if (stage === 'shipping') {
                    ...
                    return defer;
                } else if (stage === 'placeOrder' && ($('#sezzle-config').data('mode') !== 'modal' || $('#sezzle-config').data('vcnenabled') === true)) {
                   
              if( $('#vcn-data').data('vcncomplete') || !$('#sezzle-config').data('vcnenabled') ) {
