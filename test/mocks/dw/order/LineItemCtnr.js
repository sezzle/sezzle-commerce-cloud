...
var paymentInstruments = [new OrderPaymentInstrument('METHOD_BANK_TRANSFER', new Money(140, 'USD')), new OrderPaymentInstrument('METHOD_CREDIT_CARD', new Money(140, 'USD')), new OrderPaymentInstrument('Sezzle', new Money(140, 'USD'))];
