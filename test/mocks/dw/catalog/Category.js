...
var custom = {
    SezzleFPName: 'DefaultFinProgram',
    SezzleFPMode: 'SezzleFPMode',
    SezzleFPPriority: 0,
    SezzleFPStartDate: new Date(new Date().getTime() - (1000 * 60 * 60 * 100)),
    SezzleFPEndDate: new Date(new Date().getTime() + (1000 * 60 * 60 * 100))
};
