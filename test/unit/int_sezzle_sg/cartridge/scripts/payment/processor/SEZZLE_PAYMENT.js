...
var SezzlePayment = proxyquire('../../../../../../../cartridges/int_sezzle_sg/cartridge/scripts/payment/processor/SEZZLE_PAYMENT', {
...
describe('int_sezzle_sg/cartridge/scripts/payment/processor/SEZZLE_PAYMENT', function () {
    ...
    context('method Authorize', function () {
        ...
        it('authorize', function () {
            ...
            assert.deepEqual(SezzlePayment.Authorize(args),
                {
                    authorized: true
                });
        });
